...
void	test_cd(void)
{
	...
	envp[3] = "SHLVL=1";
	envp[4] = "PWD=julia/my_lolder_with_dream_pwd";
	envp[5] = "CLASSIC_VAR=classic_value";
	envp[6] = NULL;
	...
	assert(strcmp(new_envp[4], "CLASSIC_VAR=classic_value") == 0);
	assert(strcmp(new_envp[5], "OLDPWD=julia/my_lolder_with_dream_pwd") == 0);
	if (new_envp[6] != NULL)
		printf("nope, there is smth instead of NULL:\n%s\n", new_envp[6]);
	free(new_envp);
	

	arguments[0] = "/Users/yuliia/Desktop/minishell";
	arguments[1] = NULL;
	...
	assert(strcmp(new_envp[1], "HOME=/Users/yuliia") == 0);
	assert(strcmp(new_envp[2], "SHLVL=1") == 0);
	assert(strcmp(new_envp[3], "PWD=/Users/yuliia/Desktop/minishell") == 0);
	assert(strcmp(new_envp[4], "CLASSIC_VAR=classic_value") == 0);
	assert(strcmp(new_envp[5], "OLDPWD=julia/my_lolder_with_dream_pwd") == 0);
	if (new_envp[6] != NULL)
		printf("nope, there is smth instead of NULL:\n%s\n", new_envp[6]);
	
	arguments[0] = "Desktop/minishell"; // wrong folder
	arguments[1] = NULL;
	...
	assert(strcmp(new_envp[1], "HOME=/Users/yuliia") == 0);
	assert(strcmp(new_envp[2], "SHLVL=1") == 0);
	assert(strcmp(new_envp[3], "PWD=julia/my_lolder_with_dream_pwd") == 0);
	assert(strcmp(new_envp[4], "CLASSIC_VAR=classic_value") == 0);
	if (new_envp[5] != NULL)
		printf("nope, there is smth instead of NULL:\n%s\n", new_envp[6]);

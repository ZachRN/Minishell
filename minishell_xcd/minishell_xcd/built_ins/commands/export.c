...
int new_env_array_size(t_env_data *data)
{
	int i;
...
void	copy_str_for_data(t_env_data *data, int i_dst, int i_src)
{
...
int	alter_envp_new_list(t_env_data *data, int i) /// here I need to check if var is new, if new, I add in end of arr or rewrite one exsisted
{
	int n;
